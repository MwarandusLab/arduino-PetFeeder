...
#define BOARD_BUTTON_ACTIVE_LOW    true  // Adjust based on your button configuration
...
#endif
  attachInterrupt(digitalPinToInterrupt(BOARD_BUTTON_PIN), button_change, CHANGE);
}
